...
enum mir3da_sensor_type {
	MIR3DA_SENSOR_TYPE_ACC,
	MIR3DA_SENSOR_TYPE_STEP_COUNTER,
	MIR3DA_SENSOR_TYPE_MAX
};

int mir3da_step_register_init(void);
uint32_t mir3da_sc_get_step(void);
//int mir3da_setPowerMode(int sensorType, bool enable);

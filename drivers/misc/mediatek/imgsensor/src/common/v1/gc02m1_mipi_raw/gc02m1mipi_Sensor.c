...
static struct imgsensor_info_struct imgsensor_info = {
	...
	// .checksum_value = 0x5622f670,//cjc0225
	.checksum_value = 0xdb6e1e1f,//cjc0225	// zyonghong modified to 0xdb6e1e1f for 47450
	.pre = {
		.pclk = 84000000,
		.linelength = 2192,
		.framelength = 1276,
    ...
    .sensor_mode_num = 5,      //support sensor mode num , //define for dual camera by anxiang.xiao 20190102
...
printk("gc02m1,get_imgsensor_id\n");

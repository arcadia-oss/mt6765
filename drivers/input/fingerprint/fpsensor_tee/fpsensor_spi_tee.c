...
/*
#if 1//def CONFIG_PM_WAKELOCKS
struct wakeup_source *fpsensor_timeout_wakelock;
#else
struct wake_lock fpsensor_timeout_wakelock;
#endif
*/
/* global variables */
...
/*	
#if 1//def CONFIG_PM_WAKELOCKS
	__pm_wakeup_event(fpsensor_timeout_wakelock, jiffies_to_msecs(1*HZ));
#else
	wake_lock_timeout(&fpsensor_timeout_wakelock,1*HZ);
#endif
*/
    setRcvIRQ(1);
...
/*
#if 1//def CONFIG_PM_WAKELOCKS
	 fpsensor_debug(INFO_LOG, "%s wakeup_source_destroy 33333\n", __func__);
	 wakeup_source_destroy(fpsensor_timeout_wakelock);
#else	
...
/*
#if 1//def CONFIG_PM_WAKELOCKS
		fpsensor_timeout_wakelock=wakeup_source_register(NULL, "fpsensor_ttw_wl");
#else
    wake_lock_init(fpsensor_timeout_wakelock, WAKE_LOCK_SUSPEND, "fpsensor_ttw_wl");
#endif	
*/
    fpsensor_dev->device_available = 1;
#if FP_NOTIFY

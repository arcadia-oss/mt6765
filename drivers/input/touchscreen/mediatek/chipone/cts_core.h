...
enum cts_firmware_cmd {
    ...
    CTS_CMD_EP_PLUG_IN = 0x57,//earphone plugged in
    CTS_CMD_EP_PLUG_OUT = 0x58,//earphone plugged out
...
extern bool cts_is_earphone_exist(struct cts_device *cts_dev);
extern int cts_earphone_plugin(struct cts_device *cts_dev);
extern int cts_earphone_plugout(struct cts_device *cts_dev);
#else /* CONFIG_CTS_EARPHONE_DETECT */
static inline bool cts_is_earphone_exist(struct cts_device *cts_dev) {return false;}
static inline int cts_earphone_plugin(struct cts_device *cts_dev) {return 0;}
static inline int cts_earphone_plugout(struct cts_device *cts_dev) {return 0;}
